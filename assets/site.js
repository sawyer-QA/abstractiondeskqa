/* Shared site behavior — AbstractionDeskQA (T-04)
   ...
   their underlying markup and accessibility behavior genuinely differ:
     - switchTab: sep1-tool/hbips-tool (.tab-panel/.tab-btn/.active, click-only)
     - showTab:   lkw-tool/cmo-tool (.panel/.tab/.on, click + T-10's roving-tabindex/keydown)
   Both are now wired via a delegated click listener reading data-tab/data-t instead of
   inline onclick, advancing TD-2. sep1/hbips do NOT gain T-10's roving-tabindex here —
   that would be an accessibility enhancement, not a dedup, and is left as a candidate
   follow-up. See ARCHITECTURE.md §5 / TD-1 / TD-2. */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ── switchTab (sep1-tool, hbips-tool) ── */
